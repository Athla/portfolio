  ...
  return (
    <>
      <div className="experience">
        ...
        <p>Worked mainly with Microservices, Internal API's and Data Pipelines.</p>
        <p>Next to this text, you will find a more in depth vision of what I'm used to do.</p>
